...
const GOOGLE_CLIENT_ID =
  "841209854387-0c00ohrkebcjgkmhf86fi1nqj4qjhlqv.apps.googleusercontent.com";
const GOOGLE_SCOPE = "https://www.googleapis.com/auth/calendar";
const WORKER_URL = "https://google-auth.itla-plus.workers.dev";

const SVG = {
  GOOGLE_CALENDAR: `<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 256 256">
